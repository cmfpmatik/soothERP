...
tab_alerte["form_change"]	=	new Array ('Formulaire modifié', 'Le formulaire a été modifié', '<a class="btn btn-small btn-danger" name="bouton1" id="bouton1"><i class="icon-trash"></i> Ignorer les modifications </a> <a class="btn btn-small" id="bouton0" name="bouton0"><i class="icon-undo"></i> Retour</a>');
