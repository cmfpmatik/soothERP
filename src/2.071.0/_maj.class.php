...
function __construct ($version_after_maj) {
	...
	$this->tmp_files_dir = $CORE_DIR."echange_lmb/maj_lmb_".$this->version_after_maj."/";
	...
	$this->break_point_file = $CORE_DIR."echange_lmb/v".$this->version_after_maj."_break_points.tmp";
...
function read_xml_file () {
	...
	$this->parseurXML = xml_parser_create("UTF8");
