...
$MODELES_DIR = $DIR."modeles/";
$ODS_MODELES_DIR 	= $MODELES_DIR."modeles_ods/";
...
$MSG_MODELES_DIR 	= $MODELES_DIR."modeles_msg/";
$TPL_MODELES_DIR 	= $MODELES_DIR."modeles_tpl/";
