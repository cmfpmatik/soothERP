...
if(file_exists($LIBDIR.$res->i.dossier."inscription_".substr($res->i.dossier, 0, -1).".class.php")){
	require_once($LIBDIR.$res->i.dossier."inscription_".substr($res->i.dossier, 0, -1).".class.php");
