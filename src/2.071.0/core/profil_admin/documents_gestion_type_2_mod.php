...
maj_configuration_file ("_doc_".strtolower($code_doc).".config.php", "maj_line", "\$COMMANDE_CLIENT_AUTO_GENERE	=", "\$COMMANDE_CLIENT_AUTO_GENERE	= \"".$cdc_auto."\";	// code doc du type de doc créé à la validation de la commande", $LIBDIR."documents/");
